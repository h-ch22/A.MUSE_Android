...
fun BookView(){
    ...
    val categories = stringArrayResource(id = R.array.CATEGORIES_BOOK)
        ...
        ModalBottomSheetLayout(sheetContent = {
            ...
            Surface(modifier = Modifier.fillMaxSize()) {
                LaunchedEffect(key1 = true) {
                    helper.getContents(ContentsTypeModel.BOOK){
                        for(i in 0 until if(ContentsHelper.bookContents.size > 3) 3 else ContentsHelper.bookContents.size){
                            bestContents.add(
                                ContentsHelper.bookContents[i]
                            )
                        }
                ...
                Column(modifier = Modifier
                    ...
                    if(showProgress){
                        ...
                        Spacer(modifier = Modifier.weight(1f))
                    } else if(ContentsHelper.bookContents.isEmpty()) {
                        Spacer(modifier = Modifier.weight(1f))
